# Advent of Code 2023 Day 03 - Implementation Task

Solve both Part 1 and Part 2 of the problem.

## Your Mission

You are the orchestrator for solving Advent of Code 2023 Day 03. Your job is to:

1. **Read the problem**: Study `2023/day03/problem.md` to understand what needs to be solved.
...
4. **Submit the answer**: Once you have consensus on the answer, use the submit script:
   `node runner/submit.js 2023 3 <part> <answer>`
...
7. **Update documentation**: Update `2023/README.md` with:
   - Progress table entry for Day 03
   - Benchmark results table for Day 03
...
- Agents should read `2023/day03/problem.md` for the problem description
...
Solutions go in: `2023/day03/<language>/solution.<ext>`

Examples:
- `2023/day03/python/solution.py`
- `2023/day03/node/solution.js`
- `2023/day03/c/solution.c`

Input file is at: `2023/day03/input.txt`
